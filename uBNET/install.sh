#!/bin/bash
# uBNET Installation Script
# Installs uBNET - Ubuntu Network Monitor
...
# Copy main script
cp "$SCRIPT_DIR/ubnet.py" "$BIN_DIR/ubnet"
chmod +x "$BIN_DIR/ubnet"
...
Type=Application
Name=$APP_NAME
Comment=Ubuntu Network Monitor
Exec=$BIN_DIR/ubnet
...
Type=Application
Name=$APP_NAME
Comment=Ubuntu Network Monitor - System tray network bandwidth monitor
Exec=$BIN_DIR/ubnet
Icon=network-transmit-receive
Terminal=false
Categories=System;Monitor;Utility;
Keywords=network;bandwidth;upload;download;speed;monitor;system;
EOF
...
echo "=========================================="
echo ""
echo "To start now:  ubnet &"
echo "To stop:       killall ubnet"
echo ""
